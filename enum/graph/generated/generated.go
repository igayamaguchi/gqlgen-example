...
type ComplexityRoot struct {
	...
	Query struct {
		...
		Articles func(childComplexity int, status model.Status) int
	}
}

type QueryResolver interface {
	Article(ctx context.Context, id string) (*model.Article, error)
	Articles(ctx context.Context, status model.Status) ([]*model.Article, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.articles":
		...
		return e.complexity.Query.Articles(childComplexity, args["status"].(model.Status)), true
...
func (ec *executionContext) field_Query_articles_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["status"]; ok {
		...
		arg0, err = ec.unmarshalNStatus2githubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐStatus(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Article_status(ctx context.Context, field graphql.CollectedField, obj *model.Article) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNStatus2githubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_article(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOArticle2ᚖgithubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐArticle(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_articles(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Articles(rctx, args["status"].(model.Status))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*model.Article)
	fc.Result = res
	return ec.marshalOArticle2ᚕᚖgithubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐArticleᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNArticle2ᚖgithubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNStatus2githubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐStatus(ctx context.Context, v interface{}) (model.Status, error) {
	var res model.Status
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNStatus2githubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐStatus(ctx context.Context, sel ast.SelectionSet, v model.Status) graphql.Marshaler {
	return v
}
...
func (ec *executionContext) marshalOArticle2ᚕᚖgithubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐArticleᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Article) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNArticle2ᚖgithubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐArticle(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOArticle2ᚖgithubᚗcomᚋigayamaguchiᚋgqlgenᚑexampleᚋenumᚋgraphᚋmodelᚐArticle(ctx context.Context, sel ast.SelectionSet, v *model.Article) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Article(ctx, sel, v)
